...
public class Main implements Runnable {
    ...
    private static int getMaxDiff(String s) {
        ...
        for (int i = 0; i < s.length(); i++) {
            ...
            remainingFreq[charIdx]--;
            if (currFreq[charIdx] == 0 && remainingFreq[charIdx] > 0) {
                diff++;
            } else if (currFreq[charIdx] > 0 && remainingFreq[charIdx] == 0) {
                diff--;
            }
            currFreq[charIdx]++;
