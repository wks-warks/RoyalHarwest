...
public class Main implements Runnable {
    ...
    public void run() {
        ...
        long satisfyingPairs = computeSatisfyingPairs(a);
        out.println(satisfyingPairs);
        
        out.close();
    }

    private static long computeSatisfyingPairs(int[] a) {
        long satisfyingPairs = 0;
        int[] freq = new int[20];
        ...
        for (int right = 0; right < a.length; right++) {
            ...
            for (int bitIdx = 0; bitIdx < 20; bitIdx++) {
                if ((a[right] & (1 << bitIdx)) > 0) {
                    freq[bitIdx]++;
            ...
            satisfyingPairs += right - left + 1;
        }

        return satisfyingPairs;
    }
}
