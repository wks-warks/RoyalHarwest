...
public class Main implements Runnable {
    ...
    public void run() {
        ...
        int[] xy = getXY(xCoordinates, yCoordinates);
        out.println(xy[0] + " " + xy[1]);
        
        out.close();
    }

    private static int[] getXY(Set<Integer> xCoordinates, Set<Integer> yCoordinates) {
        int[] xy = new int[2];
        for (var num : xCoordinates) {
            xy[0] = num;
        }

        for (var num : yCoordinates) {
            xy[1] = num;
        }
