...
public class Main implements Runnable {
    ...
    private static List<Integer> getRes(int a, int b, int k) {
        List<Integer> list = new ArrayList<Integer>();
        populate(list, a, Math.min(a + k - 1, b));
        populate(list, Math.max(a + k, b - k + 1), b);
        
        return list;
    }

    private static void populate(List<Integer> list, int start, int end) {
