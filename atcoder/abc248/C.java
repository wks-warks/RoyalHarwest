...
public class Main implements Runnable {
    ...
    public void run() {
        ...
        int count = getCount(n, m, k);
        out.println(count);
        
        out.close();
    }

    static final int PRIME = 998_244_353;
    static Map<Triple, Integer> memo = new HashMap<Triple, Integer>();
    private static int getCount(int n, int m, int k) {
        Triple key = new Triple(n, m, k);
...
class Triple {
  ...
  public int hashCode() {
    ...
    int hash = first % prime;
    hash = (int) ((long) hash * second % prime);
    hash = (int) ((long) hash * third % prime);
