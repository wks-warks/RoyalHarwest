...
public class Main implements Runnable {
    ...
    public void run() {
        ...
        boolean communicate = canCommunicate(a, b, c, d);
        out.println(communicate ? "Yes" : "No");
        
        out.close();
    }

    private static boolean canCommunicate(int a, int b, int c, int d) {
        return canDirectlyCommunicate(a, c, d) || (canDirectlyCommunicate(a, b, d) && canDirectlyCommunicate(b, c, d));
    }

    private static boolean canDirectlyCommunicate(int a, int b, int d) {
