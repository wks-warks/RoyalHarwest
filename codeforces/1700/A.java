...
public class Main implements Runnable {
    ...
    private static long getMinCost(int m, int n) {
        long topCost = ((long) n * (n + 1)) >> 1;
        long rightCost = (((long) m * (m + 1)) >> 1) * n;
        long overlap = n;
        // out.println(topCost + " " + rightCost + " " + overlap);
        long minCost = topCost + rightCost - overlap;
        return minCost;
    }
}
