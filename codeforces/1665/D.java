...
public class Main implements Runnable {
    ...
    void interact() {
        ...
        for (int i = 0; i < 30; i++) {
            ...
            out.println(ask(lower - subtract, higher - subtract));
            out.flush();

            int gcd = in.nextInt();
            // out.println("lower : " + lower + " " + " sub : " + subtract);
            if ((gcd & (lower << 1)) == (lower << 1)) {
                // i-th bit was set
                answer |= lower;
                subtract |= lower;
            }
        ...
        out.println(String.format("! %d", answer));
        out.flush();
    }
    ...
    void interact(int x) {
        ...
        for (int i = 0; i < 30; i++) {
            ...
            // int gcd = in.nextInt();
            int gcd = GCD(x + lower - subtract, x + higher - subtract);
            // out.println("lower : " + lower + " " + " sub : " + subtract);
            if ((gcd & (lower << 1)) == (lower << 1)) {
                // i-th bit was set
                answer |= lower;
