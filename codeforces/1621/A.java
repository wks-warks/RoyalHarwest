...
public class A implements Runnable {
    ...
    public void run() {
        ...
        for (int t = 0; t < tests; t++) {
            ...
            char[][] arrangement = getStableArrangement(dimension, rooks);
            if (arrangement == null) {
                out.println(-1);
            } else {
                for (var row : arrangement) {
                    for (var ch : row) {
                        out.print(ch);
                    }
                    out.println();
    ...
    private static char[][] getStableArrangement(int dimension, int rooks) {
        char[][] arrangement = new char[dimension][dimension];
